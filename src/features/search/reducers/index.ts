...
import { State as RequestDataState, reducer as requestDataReducer } from './requestData';
...
function responseMetaReducer(state: ResponseMetaState = initialResponseMetaState, action) {
  switch (action.type) {
